...
print ('O faturamento da loja foi de: ' + str(faturamento) + ' custo de '+ str(custo) + ' lucro de '+ str(lucro))

"""Uso do Format"""
print('O faturamento da loja foi de: {}, custo de {} e lucro de {}'.format(faturamento, custo, lucro) )


"""Uso do %s e %d"""
print ('O faturamento da loja foi de: %d, custo de %d e lucro de %d' %(faturamento, custo,lucro))
